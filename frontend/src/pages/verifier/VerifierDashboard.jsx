    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">Welcome, {user?.company_name || user?.companyName}!</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600 text-sm">Successful verifications</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600 text-sm">API calls this month</p>
          </div>
        </div>
        ...
        {(user?.verification_status === 'pending' || user?.verificationStatus === 'pending') && (
          <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <p className="text-yellow-800 mb-4">
              Your verifier account is pending admin approval. You'll be able to verify credentials once approved.
            </p>
          </div>
        )}
        ...
        {(user?.verification_status === 'approved' || user?.verificationStatus === 'approved') && (
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <button className="bg-indigo-600 text-white p-6 rounded-lg hover:bg-indigo-700 text-left">
              <h3 className="text-lg font-semibold mb-2">Run Verification</h3>
              <p className="text-indigo-100 text-sm">Verify a credential instantly</p>
            </button>
            ...
            <button className="bg-green-600 text-white p-6 rounded-lg hover:bg-green-700 text-left">
              ...
              <p className="text-green-100 text-sm">Access verification history and reports</p>
            </button>

            <button className="bg-purple-600 text-white p-6 rounded-lg hover:bg-purple-700 text-left">
              <h3 className="text-lg font-semibold mb-2">API Keys</h3>
              <p className="text-purple-100 text-sm">Manage your API keys and integrations</p>
            </button>

            <button className="bg-orange-600 text-white p-6 rounded-lg hover:bg-orange-700 text-left">
              <h3 className="text-lg font-semibold mb-2">API Documentation</h3>
              <p className="text-orange-100 text-sm">View API docs and examples</p>
            </button>
          </div>
        )}
      </main>
