      ...
      <main className="ml-64 p-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <button className="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {logs.map((log) => (
                      <div key={log.id} className="flex items-start p-4 bg-gray-50 rounded-lg">
                        <div className={`p-2 rounded-full ${
                          log.verification_result === 'success' ? 'bg-green-100' : 'bg-red-100'
                        }`}>
                          <svg className={`w-5 h-5 ${
                            log.verification_result === 'success' ? 'text-green-600' : 'text-red-600'
                        ...
                        <div className="ml-4 flex-1">
                          <div className="flex items-center justify-between">
                            <p className="font-medium text-gray-900">{log.verifier_name || 'Unknown Verifier'}</p>
