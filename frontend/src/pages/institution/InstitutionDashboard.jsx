    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <aside className="fixed inset-y-0 left-0 w-64 border-r border-slate-200 bg-white/90 text-slate-900 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
        ...
        <nav className="mt-3 px-3">
          <Link to="/institution/dashboard" className="flex items-center rounded-2xl border border-transparent bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3 text-white shadow-lg shadow-purple-200/50">
      ...
      <main className="ml-64 min-h-screen p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-black tracking-tight text-slate-900">Institution Dashboard</h1>
            <p className="text-slate-600">Welcome, {user?.name || 'Institution Admin'}</p>
          </div>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
                  ...
                  <p className="mt-2 text-3xl font-black text-slate-900">{stats.totalIssued || 0}</p>
                </div>
                <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
                  <p className="text-sm text-slate-500">Total Users</p>
                  <p className="mt-2 text-3xl font-black text-slate-900">{stats.totalUsers || 0}</p>
                </div>
                <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
                  <p className="text-sm text-slate-500">This Month</p>
                  <p className="mt-2 text-3xl font-black text-slate-900">{stats.last30Days || 0}</p>
                </div>
                <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
                  <p className="text-sm text-slate-500">Expiring Soon</p>
                  <p className="mt-2 text-3xl font-black text-slate-900">{stats.expiringSoon || 0}</p>
                </div>
              </div>
            </>
          ) : null}
